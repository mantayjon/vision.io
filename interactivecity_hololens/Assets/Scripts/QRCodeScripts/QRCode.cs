...
namespace Microsoft.MixedReality.SampleQRCodes
{
    ...
    public class QRCode : MonoBehaviour, IMixedRealityPointerHandler
    {
        ...
        private GameObject interactiveCity;
        ...
        void UpdatePropertiesDisplay()
        {
            ...
            if (qrCode != null && lastTimeStamp != qrCode.SystemRelativeLastDetectedTime.Ticks)
            {
                ...
                interactiveCity.transform.localPosition = new Vector3(PhysicalSize / 2.0f, PhysicalSize / 2.0f, 0.0f);
                interactiveCity.transform.localScale = new Vector3(PhysicalSize, PhysicalSize, 0.005f);
